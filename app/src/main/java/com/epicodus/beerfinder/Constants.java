...
public class Constants {
    public static final String BDB_BEERS_URL = "http://api.brewerydb.com/v2/beers";
    public static final String BDB_BREWERIES_URL = "http://api.brewerydb.com/v2/breweries";
    public static final String BDB_BREWERY_URL = "http://api.brewerydb.com/v2/brewery";
